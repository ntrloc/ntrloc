...
import org.ntrloc.graph.graphql.impl.GraphQLSchemaMapperImpl;

import java.util.Set;

class GraphQLSchemaMapperTest {
    ...
    void testSchemaMapper() {
        ...
        GraphQLSchemaMapper mapper = new GraphQLSchemaMapperImpl();
        mapper.mapSchemaElements(entityDefinitions, relationshipDefinitions);
