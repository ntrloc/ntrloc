import {
  ...
  forEach,
  isArray
} from '../../../../min-dash/dist/index.js';

import AlignElementsHandler from './cmd/AlignElementsHandler.js';
import AppendShapeHandler from './cmd/AppendShapeHandler.js';
import CreateConnectionHandler from './cmd/CreateConnectionHandler.js';
import CreateElementsHandler from './cmd/CreateElementsHandler.js';
import CreateLabelHandler from './cmd/CreateLabelHandler.js';
import CreateShapeHandler from './cmd/CreateShapeHandler.js';
import DeleteConnectionHandler from './cmd/DeleteConnectionHandler.js';
import DeleteElementsHandler from './cmd/DeleteElementsHandler.js';
import DeleteShapeHandler from './cmd/DeleteShapeHandler.js';
import DistributeElementsHandler from './cmd/DistributeElementsHandler.js';
import LayoutConnectionHandler from './cmd/LayoutConnectionHandler.js';
import MoveConnectionHandler from './cmd/MoveConnectionHandler.js';
import MoveElementsHandler from './cmd/MoveElementsHandler.js';
import MoveShapeHandler from './cmd/MoveShapeHandler.js';
import ReconnectConnectionHandler from './cmd/ReconnectConnectionHandler.js';
import ReplaceShapeHandler from './cmd/ReplaceShapeHandler.js';
import ResizeShapeHandler from './cmd/ResizeShapeHandler.js';
import SpaceToolHandler from './cmd/SpaceToolHandler.js';
import ToggleShapeCollapseHandler from './cmd/ToggleShapeCollapseHandler.js';
import UpdateAttachmentHandler from './cmd/UpdateAttachmentHandler.js';
import UpdateWaypointsHandler from './cmd/UpdateWaypointsHandler.js';

import { isModelElement } from '../../model/index.js';

/**
 * @typedef {import('../../model/Types.js').Element} Element
 * @typedef {import('../../model/Types.js').Connection} Connection
 * @typedef {import('../../model/Types.js').Parent} Parent
 * @typedef {import('../../model/Types.js').Shape} Shape
 * @typedef {import('../../model/Types.js').Label} Label
 *
 * @typedef {import('../../command/CommandStack.js').default} CommandStack
 * @typedef {import('../../core/ElementFactory.js').default} ElementFactory
 * @typedef {import('../../core/EventBus.js').default} EventBus
 *
 * @typedef {import('../../command/CommandStack.js').CommandHandlerConstructor} CommandHandlerConstructor
 *
