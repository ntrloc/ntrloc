...
public class ItemObjectTypeMapping implements ObjectTypeProducer {
    ...
    private ItemPropertiesObjectTypeMapping propertiesMapping;

    public ItemObjectTypeMapping(ItemDefinition itemDefinition) {
        this.itemDefinition = itemDefinition;
        String typeName = String.format("%s", itemDefinition.getName());
        this.graphQlTypeName = CaseUtils.toCamelCase(typeName, true, '_', '-');

        propertiesMapping = new ItemPropertiesObjectTypeMapping(itemDefinition);
    }
