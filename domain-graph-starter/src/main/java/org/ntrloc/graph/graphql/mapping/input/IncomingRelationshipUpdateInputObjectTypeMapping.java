...
public class IncomingRelationshipUpdateInputObjectTypeMapping implements IncomingRelationshipInputTypeMapping, InputObjectTypeProducer {
    ...
    public IncomingRelationshipUpdateInputObjectTypeMapping(RelationshipDefinition sourceRelationshipDefinition, RelationshipPropertiesInputObjectTypeMapping propertiesMapping, MatcherChoiceInputObjectTypeMapping matcherChoiceMapping) {
        String typeName = String.format("%s %s %s Link Update Input", sourceRelationshipDefinition.getTargetEntity(), sourceRelationshipDefinition.getTargetLabel(), sourceRelationshipDefinition.getSourceEntity());
