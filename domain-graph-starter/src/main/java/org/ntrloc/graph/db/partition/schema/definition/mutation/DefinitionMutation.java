...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = AddPropertyDefinitionMutation.class,          name = "ADD_PROPERTY"),
        @JsonSubTypes.Type(value = AddPropertyGroupDefinitionMutation.class,     name = "ADD_PROPERTY_GROUP"),
        @JsonSubTypes.Type(value = UpdatePropertyGroupDefinitionMutation.class,  name = "UPDATE_PROPERTY_GROUP"),
        @JsonSubTypes.Type(value = DeletePropertyGroupDefinitionMutation.class,  name = "DELETE_PROPERTY_GROUP"),
        @JsonSubTypes.Type(value = MovePropertyGroupDefinitionMutation.class,    name = "MOVE_PROPERTY_GROUP"),
...
public sealed interface DefinitionMutation
        permits CreateItemDefinitionMutation, UpdateItemDefinitionMutation, DeleteItemDefinitionMutation,
                ...
                AddPropertyDefinitionMutation, AddPropertyGroupDefinitionMutation, UpdatePropertyGroupDefinitionMutation, DeletePropertyGroupDefinitionMutation, MovePropertyGroupDefinitionMutation,
