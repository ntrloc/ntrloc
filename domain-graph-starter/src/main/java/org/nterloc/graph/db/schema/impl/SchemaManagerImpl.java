package org.nterloc.graph.db.schema.impl;
...
import org.nterloc.graph.DuplicateException;
...
import org.nterloc.graph.db.schema.PropertyDefinition;
import org.nterloc.graph.db.schema.PropertyGroupDefinition;
import org.nterloc.graph.db.schema.PropertyType;
import org.nterloc.graph.db.schema.RelationshipDefinition;
import org.nterloc.graph.db.schema.SchemaChangeReaction;
...
import static org.nterloc.graph.db.LabelConstants.ENTITY_DEFINITION_LABEL;
import static org.nterloc.graph.db.LabelConstants.RELATIONSHIP_DEFINITION_LABEL;
...
public class SchemaManagerImpl implements SchemaManager, EntryAddedListener<String, Object>, EntryUpdatedListener<String, Object> {
    ...
    private Set<RelationshipDefinition> retrieveRelationshipDefinitions(GraphTraversal<Vertex, Vertex> startingTraversal) {
        ...
        return iter.toStream().map(v -> {
            ...
            schema.setSourceCardinality(new org.nterloc.graph.db.schema.Cardinality((Integer) propertyMap.get("sourceCardinalityMin"), (Integer) propertyMap.get("sourceCardinalityMax")));
            schema.setTargetCardinality(new org.nterloc.graph.db.schema.Cardinality((Integer) propertyMap.get("targetCardinalityMin"), (Integer) propertyMap.get("targetCardinalityMax")));
