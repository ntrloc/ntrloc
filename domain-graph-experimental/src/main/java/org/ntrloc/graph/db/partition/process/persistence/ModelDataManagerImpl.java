...
// Discovered live, not anticipated (docs/ntrloc-workflow-summary.md Section 6): earlier bytecode
...
// ACT_RE_MODEL not existing. Nothing in ntrloc ever creates a Model (confirmed via repo-wide grep,
...
public class ModelDataManagerImpl extends AbstractProcessDataManager implements ModelDataManager {
    ...
    public void insert(ModelEntity entity) {
        throw new UnsupportedOperationException("Models are never created in ntrloc");
    }
