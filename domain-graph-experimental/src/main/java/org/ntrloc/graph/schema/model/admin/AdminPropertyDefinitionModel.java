...
public record AdminPropertyDefinitionModel(UUID id, String name, String description, PropertyType type, PropertyCardinality cardinality, PropertyRequirement requirement) {
}
