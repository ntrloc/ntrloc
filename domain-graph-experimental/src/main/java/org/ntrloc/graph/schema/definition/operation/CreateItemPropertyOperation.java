...
public record CreateItemPropertyOperation(UUID itemId, String name, String description, PropertyType type, PropertyCardinality cardinality, PropertyUsage usage) implements SchemaOperation {
}
